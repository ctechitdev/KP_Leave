                        ...
                        <div class="card">
							...
							<div class="form-group col-md-2">
								<div class="form-group">
										...
										<div class="controls">
											<input type="hidden" name="leave_id" id="leave_id"  class="form-control font" value="" placeholder="ເລກທີລາພັກ" > 
										</div> 
								</div> 	 
							</div>
							...
							select lr_id,date_leave,hours_leave,date_from,time_from,date_to,time_to,reason,minus_leave,
